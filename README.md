...
1) Open the file 'image_classifier_project_part_1.ipynb' in a Jupyter-like environment.
...
### Instructions
1) Open a command line interface, and change directory to where the project is stored.
